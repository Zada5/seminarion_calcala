...
4. Optionally run `did_0710.R` on the same cleaned files for separate post-event FE estimates. This now includes placebo DiD on the canonical placebo weeks.
