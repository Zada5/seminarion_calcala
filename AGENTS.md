...
- `analysis_outputs_did/tables/did_key_results_post_from_minus1.tex`
- `analysis_outputs_did/tables/did_key_results_post_from_minus1.html`
- `analysis_outputs_did/tables/did_key_results_post_from_minus1.png`
- `analysis_outputs_did/tables/did_key_results_post_from_minus1.pdf`
- `analysis_outputs_did/post_from_0/*`
- `analysis_outputs_did/post_from_minus1/*`
- `analysis_outputs_did/placebo/post_from_0/*`
- `analysis_outputs_did/placebo/post_from_minus1/*`
- `analysis_outputs_did/oct7/post_from_0/*`
- `analysis_outputs_did/oct7/post_from_minus1/*`
...
- Additional DiD robustness outputs use `PostEvent = 1` when `relative_week >= -1` and live under `post_from_minus1` folders without replacing the baseline DiD outputs.
