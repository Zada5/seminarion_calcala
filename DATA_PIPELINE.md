...
2. Verify `data/generated/placebo_events_2020_2025.csv` has exactly `66` rows, `66` unique Sunday dates, `36` political rows, `30` terror rows, dates inside `2020-01-26` through `2025-12-07`, and minimum distance `> 3` weeks from every real event week.
...
| Real event timeline | `data/raw/events/Consolidated List of Terror and Political incidents 2020-2025 v3.csv` | manual consolidated event list | `scripts/05_event_study_0710.R`, `scripts/06_did_0710.R` |
