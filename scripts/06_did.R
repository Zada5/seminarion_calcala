...
write_paper_style_header <- function(summary_connection,
  ...
  writeLines(strrep("=", rule_width), con = summary_connection)
  writeLines("Generated by did.R from the input files listed in this run.", con = summary_connection)
  writeLines("", con = summary_connection)
...
legacy_output_paths <- file.path(
  ...
  c(
    ...
    "did_coefs_oct7.csv",
    "did_sample_summary_oct7.csv",
    "did_coefs_oct7_by_group.csv",
    "did_model_fit_oct7_by_group.csv",
    "did_sample_summary_oct7_by_group.csv",
    "did_coefficients_oct7_by_group.png",
    "did_coefs_oct7_all_party_org.csv",
    "did_coefs_oct7_post_from_minus1.csv",
    "did_sample_summary_oct7_post_from_minus1.csv",
    "did_coefs_oct7_by_group_post_from_minus1.csv",
    "did_model_fit_oct7_by_group_post_from_minus1.csv",
    "did_sample_summary_oct7_by_group_post_from_minus1.csv",
    "did_coefficients_oct7_by_group_post_from_minus1.png",
...
if (nrow(oct7_event) == 1) {
  ...
  if (nrow(oct7_group_coefficients) > 0) {
    ...
    ggplot2::ggsave(
      filename = file.path(output_paths$oct7_post_from_0, "did_coefficients_oct7_by_group.png"),
...
if (nrow(oct7_coefficient) > 0) {
  write_clean_csv(oct7_coefficient, file.path(output_paths$oct7_post_from_0, "did_coefs_oct7.csv"))
}
if (nrow(oct7_sample_summary) > 0) {
  write_clean_csv(oct7_sample_summary, file.path(output_paths$oct7_post_from_0, "did_sample_summary_oct7.csv"))
}
if (nrow(oct7_group_coefficients) > 0) {
  write_clean_csv(oct7_group_coefficients, file.path(output_paths$oct7_post_from_0, "did_coefs_oct7_by_group.csv"))
}
if (nrow(oct7_group_fit) > 0) {
  write_clean_csv(oct7_group_fit, file.path(output_paths$oct7_post_from_0, "did_model_fit_oct7_by_group.csv"))
}
if (nrow(oct7_group_sample_summary) > 0) {
  write_clean_csv(oct7_group_sample_summary, file.path(output_paths$oct7_post_from_0, "did_sample_summary_oct7_by_group.csv"))
}
...
if (nrow(oct7_coefficient) > 0) {
  cat("- oct7/post_from_0/did_coefs_oct7.csv\n")
  cat("- oct7/post_from_0/did_sample_summary_oct7.csv\n")
}
if (nrow(oct7_group_coefficients) > 0) {
  cat("- oct7/post_from_0/did_coefs_oct7_by_group.csv\n")
  cat("- oct7/post_from_0/did_model_fit_oct7_by_group.csv\n")
  cat("- oct7/post_from_0/did_sample_summary_oct7_by_group.csv\n")
  cat("- oct7/post_from_0/did_coefficients_oct7_by_group.png\n")
}
