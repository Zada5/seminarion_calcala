...
| File | N | Meaning |
|---|---|---|
| `post_from_0/did_design_overview.csv` → `full_descriptive_weekly_rows` | **9,549** | Unique entity-week rows in source panel (identical to descriptive/event-study panel) |
...
| `placebo/post_from_0/did_design_overview.csv` → `full_descriptive_weekly_rows` | **9,549** | Same source panel as real-event DiD |
...
**Cross-check across all analyses:** every `*_design_overview.csv` reports `full_descriptive_weekly_rows = 9,549`. Confirms identical source panel.
